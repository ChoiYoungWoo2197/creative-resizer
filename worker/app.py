...
def background_process():
    ...
    bg_req = BackgroundRequest(
        ...
        removal_objects=data.get("removalObjects", []),
    ...
    return jsonify({
        ...
        "localInpaintEligible": result.metrics.get("localInpaintEligible", False),
        "localCandidateCount": result.metrics.get("localCandidateCount", 0),
        "protectedOverlapPixels": result.metrics.get("protectedOverlapPixels", 0),
