...
OUTPAINT_PROMPT_SAFEZONE = (
    "You are given an advertisement image where the original ad is placed in the CENTER RECTANGLE of the canvas. "
    "The surrounding border areas (left, right, top, bottom) are empty and must be filled with background only.\n\n"
    "YOUR ONLY TASK: fill the empty border areas with natural background that matches the edges of the original center image.\n\n"
    "Left border — fill with:\n"
    "White satin fabric background. Continue the texture, soft folds, and pearly highlights visible at the left edge of the center image. "
    "Generate only background fabric — no person, no face, no body.\n\n"
    "Right border — fill with:\n"
    "Dark black background. Continue the solid black panel visible at the right edge of the center image. "
    "Generate only black background — no product, no text, no logos.\n\n"
    "Top border — fill with:\n"
    "Pale blue-white soft photographic background. Continue the studio background visible at the top edge of the center image.\n\n"
    "Bottom border — fill with:\n"
    "White satin fabric texture and soft shadows. Continue the fabric visible at the bottom edge of the center image.\n\n"
    "ABSOLUTE PROHIBITIONS — violating these is a critical failure:\n"
    "- do NOT copy, duplicate, mirror, or recreate any element from the center image (no face, no person, no product jar, no Korean text, no brand name)\n"
    "- do NOT generate any new person, face, body part, or human figure anywhere in the border areas\n"
    "- do NOT generate any product, container, jar, or object in the border areas\n"
    "- do NOT generate any text, Korean characters, brand names, or logos in the border areas\n"
    "- do NOT modify anything inside the center rectangle\n"
    "- do NOT create visible seams or hard edges at the boundary between center and border\n\n"
    "The border areas must contain only seamless background texture — fabric on the left and bottom, black on the right, soft studio background on the top."
)
