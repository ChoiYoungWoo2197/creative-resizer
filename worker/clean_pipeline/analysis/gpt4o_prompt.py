...
3. "advertising_text" : 광고 카피, 혜택 안내, 가격, 제목, 설명문 등 텍스트 영역.
                        의미 단위(헤드라인, 서브카피, 가격, CTA 등)별로 각각 독립된 객체로 분리하라.
                        절대 여러 텍스트를 하나의 박스로 합치지 마라.
                        (각 객체마다 실제 텍스트 내용을 text_content에 기입)
...
# 제약 조건 (Constraints)
- advertising_text는 반드시 의미 단위별로 분리하여 각각 독립된 객체로 출력하라.
