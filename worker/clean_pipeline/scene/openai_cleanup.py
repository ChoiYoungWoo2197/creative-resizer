...
def cleanup_no_mask(
    ...
    """TYPE B: send full original image without mask.

    gpt-image-1 sees the entire scene and determines what to remove based on the prompt.
    No pre-fill, no mask — the model decides what stays (person) and what goes (ad elements).
