...
CLEANUP_PROMPT_TYPE_B = (
    ...
    "products, merchandise, containers, packages, bottles, jars, tubes, items, "
    ...
    "KEEP EXACTLY AS-IS: "
    "the person / model / subject visible in the image. "
    "Preserve face, skin tone, hair, body, clothing, main subject features — pixel-perfect. "
    "Do NOT extend, redraw, or hallucinate any part of the human body or main subject. "
    "Keep all natural background (walls, fabric, scenery, light gradients). "
