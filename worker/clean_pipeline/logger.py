"""JSONL structured logger for clean_pipeline.

Each line is flushed immediately — compatible with:
...
class PipelineLogger:
    def __init__(
        ...
        if log_path is not None:
            ...
            # buffering=1 → line-buffered; every println flushes immediately
    ...
    def artifact_written(
        ...
        self._emit(
            "artifact_written", stage, description, {}, None, artifact=path
        )
